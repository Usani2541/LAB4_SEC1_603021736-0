...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val subjectSpiner: Spinner = spiner_subject;
        ...
        subjectSpiner.adapter = arrayAdapter

        subjectSpiner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
